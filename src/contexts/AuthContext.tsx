...
type AuthContextType = {
  user: User | null;
  profile: { full_name: string | null; role: "admin" | "user" | "receptionist" | null } | null;
  isLoading: boolean;
  isAdmin: boolean;
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const [profile, setProfile] = useState<{ full_name: string | null; role: "admin" | "user" | "receptionist" | null } | null>(null);
